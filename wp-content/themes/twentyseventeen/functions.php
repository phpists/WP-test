...
function rei_add_to_cart_button($content){
	...
	ob_start();
	?>
	Цена: <?php echo $meta = get_post_meta( get_the_ID(), 'price', true ); ?>
	<form action="/cart/?add-to-cart=<?php echo $post->ID ?>" method="post">
...
function reigel_woocommerce_get_price($price,$post){
    if ($post->post->post_type === 'film') // change this to your post type
